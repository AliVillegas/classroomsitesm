...
exports.logout = (req, res) => {
    ...
    if (req.user != null) {
        req.session = null
        req.logout()
        res.redirect('https://login.microsoftonline.com/c65a3ea6-0f7c-400b-8934-5a6dc1705645/oauth2/logout?post_logout_redirect_uri=http://classroomsmplify-20201114113648-hostingbucket-dev.s3-website-us-east-1.amazonaws.com/');
    }
}